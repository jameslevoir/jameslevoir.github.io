  ...
  return (
    <>
      ...
      <SideContent content="gallery">
          <Link to="sunset" className="grid-item"><img src="/design/thumbnail/sunset.jpg" alt="Sunset Mural Thumbnail" /></Link>
          <Link to="gymscout" className="grid-item"><img src="/design/thumbnail/gymscout.jpg" alt="GymScout App Thumbnail" /></Link>
          <Link to="sweater" className="grid-item"><img src="/design/thumbnail/sweater.jpg" alt="Sweater Design Thumbnail" /></Link>
          <Link to="depth" className="grid-item"><img src="/design/thumbnail/depth.jpg" alt="Depth Poster Thumbnail" /></Link>
      </SideContent>
    </>
  )
}
