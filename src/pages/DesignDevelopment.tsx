  ...
  return (
    <>
      ...
      <SideContent content="gallery">
          <a href="" className="grid-item"><img src="/design/sunset.png" alt="Sunset Mural Thumbnail" /></a>
          <a href="" className="grid-item"><img src="/design/gymscout.png" alt="GymScout App Thumbnail" /></a>
          <a href="" className="grid-item"><img src="/design/sweater.png" alt="Sweater Design Thumbnail" /></a>
          <a href="" className="grid-item"><img src="/design/depth.png" alt="Depth Poster Thumbnail" /></a>
      </SideContent>
    </>
  )
}
